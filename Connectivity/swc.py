def from_swc_array(data):
    '''
    Parse an SWC-format array (rows of [id, type, x, y, z, radius, parent_id])
    into an ngauge Neuron, wiring soma points and branch TracingPoints
    together via their parent ids.
    '''
