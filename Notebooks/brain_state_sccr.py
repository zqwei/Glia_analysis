...
def comp_pulse_stats_ref_chunks(dff, cond_trial=None, comp_trial=None, cond_trial_ref=None, comp_trial_ref=None, pre=None, post=None):
    ...
    for n in range(num_cells):
        _ = comp_pulse_stats_ref(dff[n], cond_trial=cond_trial, comp_trial=comp_trial, cond_trial_ref=cond_trial_ref, comp_trial_ref=comp_trial_ref, pre=pre, post=post)
        cell_stats[n]=_[0]
    return cell_stats
